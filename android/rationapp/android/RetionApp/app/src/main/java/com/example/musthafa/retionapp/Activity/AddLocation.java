...
public class AddLocation extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edist=(EditText)findViewById(R.id.district);
    ...
    private void addLocation() {
        RequestQueue requestQueue=Volley.newRequestQueue(AddLocation.this);
        Intent intent=getIntent();
        final String email=intent.getStringExtra("email");
        final String state=estate.getText().toString().trim();
        final String dist=edist.getText().toString().trim();
        final String city=ecity.getText().toString().trim();
        String Url="http://ration.fabstudioz.com/addlocation.php";
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                {
                    Intent intent1=new Intent(getApplicationContext(),DealerHomeActivity.class);
